...
<head>
    ...
    <title>Akses : Admin Olshop</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">ADMIN OLSHOP</a> 
            </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <a href="index.php?halaman=pelanggan"><i class="fa fa-user "></i> Pelanggan</a><a href="index.php?halaman=logout"><i class="fa fa-sign-out "></i> Logout</a>
                    </li>
